...
describe('get string 24hr', () => {
	it('expects get 0:30 hrs12 => 12', () => {
		expect(get.string24hr('0:30').hrs12).to.equal(12)
	})
	it('expects get 0:30 hrs24 => 0', () => {
		expect(get.string24hr('0:30').hrs24).to.equal(0)
	})
	it('expects get 0:30 min => 30', () => {
		expect(get.string24hr('0:30').min).to.equal(30)
	})
	it('expects get 0:30 mode => AM', () => {
		expect(get.string24hr('0:30').mode).to.equal('AM')
	})
})
